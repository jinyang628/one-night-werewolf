...
const _strings = <String, Map<String, String>>{
  'en': {
    ...
    'end_game_home': 'End game and return home',
    'role_reveal': 'ROLE REVEAL',
    'role_privacy': 'Make sure only you can see the screen.',
    'ready': 'I’m ready',
    'night_action': 'NIGHT ACTION',
    'face_top': 'Face the top side',
    'face_right': 'Face the right side',
    'face_bottom': 'Face the bottom side',
    ...
    'role_not_among_players':
        'This role is in the dealt pool but is not held by a player.',
    'waiting_role_reveals': 'Waiting for everyone to reveal their role…',
    'preparing_night': 'Preparing the next night action…',
    'secret_vote': 'SECRET VOTE',
    'pass_vote': 'Pass the phone without revealing your choice.',
    'cast_vote': 'Cast my vote',
    'waiting_for_votes': 'Vote submitted. Waiting for the other players…',
    ...
    'configure_roles_count': 'Configure roles · {count} cards',
    'host_controls_roles': 'Only the host can change the role composition.',
    'choose_roles': 'Choose role composition',
    'role_count_instruction':
        'Select exactly {required} cards. {selected} selected.',
    'add_role': 'Add role',
    ...
    'ready_to_vote': 'I am ready to vote',
  ...
  'zh': {
    ...
    'waiting_role_reveals': '正在等待所有玩家查看身份…',
    'preparing_night': '正在准备下一个夜间行动…',
    'secret_vote': '秘密投票',
    'pass_vote': '选择后请传递手机，不要透露投票。',
    'cast_vote': '开始投票',
    'waiting_for_votes': '投票已提交，正在等待其他玩家…',
    ...
    'host': '房主',
    'start_room': '开始游戏',
    'configure_roles': '配置身份牌',
    'configure_roles_count': '配置身份牌 · {count} 张',
    'host_controls_roles': '只有房主可以更改身份牌组合。',
    'choose_roles': '选择身份牌组合',
    'role_count_instruction': '请选择正好 {required} 张牌。当前已选 {selected} 张。',
    'add_role': '添加身份牌',
    'remove_role': '移除身份牌',
    'cancel': '取消',
    'save_roles': '保存组合',
